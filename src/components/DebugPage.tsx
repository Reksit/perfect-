...
const DebugPage: React.FC = () => {
  ...
  const loadDebugData = async () => {
    ...
    try {
      // Test status
      const statusResponse = await fetch('https://finalbackendd.onrender.com/api/debug/status');
    ...
    try {
      // Test events
      const eventsResponse = await fetch('https://finalbackendd.onrender.com/api/debug/events');
    ...
    try {
      // Test alumni
      const alumniResponse = await fetch('https://finalbackendd.onrender.com/api/debug/alumni');
