...
const ManagementEventApproval: React.FC = () => {
  ...
  const loadPendingRequests = async () => {
    try {
      ...
      const response = await axios.get('https://finalbackendd.onrender.com/api/management/events/pending', {
        headers: {
  ...
  const handleApprove = async (eventId: string) => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await axios.put(`https://finalbackendd.onrender.com/api/management/events/${eventId}/approve`, {}, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const handleReject = async (eventId: string) => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await axios.put(`https://finalbackendd.onrender.com/api/management/events/${eventId}/reject`, {
